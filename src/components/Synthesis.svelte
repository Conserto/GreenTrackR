<script lang="ts">
  ...
  import { SynthesisSrv } from '../service';
  import Tooltip from './Tooltip.svelte';
  import { formatNbRequest, formatNumber, formatSizeTransferred } from '../utils/index.js';
...
<div class="synthesis-container">
  <table class="table">
    ...
    <tr>
      ...
      <th class="scroll" scope="col" colspan="6">Scroll</th>
      <th scope="col" colspan="6">Click</th>
      <th class="page" scope="col" colspan="5">Page</th>
    </tr>
    <tr>
      <th scope="col" colspan="1">Url</th>
      <th class="scroll" scope="col" colspan="1">count</th>
      <th class="scroll" scope="col" colspan="1">taille</th>
      <th class="scroll" scope="col" colspan="1">request</th>
      <th class="scroll" scope="col" colspan="1">GES</th>
      <th class="scroll" scope="col" colspan="1">Score</th>
      <th class="scroll" scope="col" colspan="1">Grade</th>
      <th scope="col" colspan="1">count</th>
      <th scope="col" colspan="1">taille</th>
      <th scope="col" colspan="1">request</th>
      <th scope="col" colspan="1">GES</th>
      <th scope="col" colspan="1">Score</th>
      <th scope="col" colspan="1">Grade</th>
      <th class="page"  scope="col" colspan="1">taille</th>
      <th  class="page" scope="col" colspan="1">request</th>
      <th  class="page" scope="col" colspan="1">GES</th>
      <th  class="page" scope="col" colspan="1">Score</th>
      <th  class="page" scope="col" colspan="1">Grade</th>
    </tr>
    </thead>
    <tbody>
    {#each synthesis.pages as page, index}
      <tr class:even={index % 2 === 0}>
        ...
        <td class="scroll" >{formatSizeTransferred(page.sScroll.network.network.size, page.sScroll.network.network.sizeUncompress)}</td>
        ...
        {:else }
          ...
          <td></td>
        {/if}
        <td class="page" >{formatSizeTransferred(page.sPage.network.network.size, page.sPage.network.network.sizeUncompress)}</td>
    ...
    <tr>
      ...
      <th class="scroll" >{formatSizeTransferred(synthesis.total.sScroll.network.network.size, synthesis.total.sScroll.network.network.sizeUncompress)}</th>
      <th class="scroll" >{formatNbRequest(synthesis.total.sScroll.network.nbRequest, synthesis.total.sScroll.network.nbRequestCache)}</th>
      ...
      {:else }
        ...
        <th></th>
      {/if}
      <th class="page" >{formatSizeTransferred(synthesis.total.sPage.network.network.size, synthesis.total.sPage.network.network.sizeUncompress)}</th>
      <th class="page" >{formatNbRequest(synthesis.total.sPage.network.nbRequest, synthesis.total.sPage.network.nbRequestCache)}</th>
